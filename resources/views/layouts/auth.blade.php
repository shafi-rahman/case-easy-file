                    ...
                    <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center">
                        <div style="max-width: 25rem;">
                            <div class="mb-4">
                                ...
                                <img src="{{ url('assets\img\ecf_logo.png') }}" width="200px;" />
                            </div>
                            {{-- <div class="mb-5">
                            ...
                            <ul class="list-unstyled mb-5">
                                ...
                                <li>
                                    <span class="d-block mb-1 fs-4 fw-light">Easily add &amp; manage your cases</span>
                                    <span class="color-600">It combines cases, follow-ups, payments, automated filing, and more.</span>
                                </li>
                            </ul>
                            <div class="mb-2">
